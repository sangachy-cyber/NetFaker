...
from holowan.v2._commons import (
    _capture_clean_url,
    _capture_delete_file_url,
    _capture_filter_url,
    _capture_get_all_file_url,
    _capture_get_pixel_data,
    _capture_get_pixel_status,
    _capture_load_file_url,
    _capture_mode_url,
    _capture_pcap_export_url,
    _capture_release_file_url,
    _capture_settings_url,
    _capture_start_url,
    _capture_stop_url,
)
...
class Pixel(object):
    ...
    def __init__(self, holowan_ip: IPv4Address, holowan_port: PortNumber, engine_id: EngineID) -> None:
    ...
    def export_pcap(self, file_path: str):
        ...
        return mt.create_and_write_file(file_path, requests.get(url).content)
